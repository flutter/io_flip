...
CustomTransitionPage<T> buildGameTransition<T>({
...
class _GameReveal extends StatefulWidget {
  const _GameReveal({
    required this.child,
  ...
  @override
  State<_GameReveal> createState() => _GameRevealState();
}

class _GameRevealState extends State<_GameReveal> {
  ...
  @override
  void didUpdateWidget(covariant _GameReveal oldWidget) {
