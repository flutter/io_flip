...
describe('deleteUserData', () => {
  ...
  after(() => {
    ...
    tester.cleanup();
    Object.defineProperty(admin, 'firestore', oldFirestore);
    Object.defineProperty(admin, 'storage', oldStorage);
  });
  ...
  it('should delete cards, decks, matches, match states, scorecards, and connection states',
    async () => {
      ...
      expect(docStub.withArgs(uid).calledTwice).to.be.true;
